...
export const TodoItemDetailPane: FC<TodoItemDetailPaneProps> = memo((props: TodoItemDetailPaneProps): ReactElement => {
  ...
  return <Stack>
            ...
            {!props.item && <Stack.Item tokens={stackItemPadding} style={{
      textAlign: "center"
    }} align="center">
                    <FontIcon iconName="WorkItem" style={{
        fontSize: 24,
        padding: 20
      }} />
